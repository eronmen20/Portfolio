        ...
        <div className="py-12 grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              Biology Education graduate passionate about science, research, and
          ...
          <div className="flex md:justify-end items-start">
            <button
              onClick={scrollToTop}
              className="flex items-center gap-2 px-5 py-3 rounded-xl bg-muted border border-border hover:border-primary/30 hover:text-primary transition-all text-sm font-medium cursor-pointer"
            >
